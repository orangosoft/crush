        ...
        <div class="flex flex-col gap-2">
          <div class='flex items-center text-sm font-bold pl-2'>
            ...
            <div class="flex items-center justify-center">
              <Button size='small' class='h-6 w-8 !p-0' disabled={isPrevDisabled()} onClick={prev}>
                <FiChevronLeft class='w-4 h-4 pointer-events-none' />
              </Button>
              <Button size='small' class='h-6 w-8 !p-0' onClick={today}>
                <FaRegularCircle size={10} class='pointer-events-none' />
              </Button>
              <Button size='small' class='h-6 w-8 !p-0' onClick={next}>
